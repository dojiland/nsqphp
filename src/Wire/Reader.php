...
use Per3evere\Nsq\Exception\ReadException;
use Per3evere\Nsq\Exception\ErrorFrameException;
use Per3evere\Nsq\Exception\ResponseFrameException;
use Per3evere\Nsq\Exception\UnknownFrameException;
